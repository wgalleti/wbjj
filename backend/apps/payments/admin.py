...
class PaymentInline(TabularInline):
    ...
    fields = ['payment_method', 'amount', 'processing_fee', 'payment_date', 'status', 'external_id']
...
class InvoiceAdmin(ModelAdmin):
    list_display = ['student', 'reference_month', 'due_date', 'get_amount_display', 'get_status_display', 'get_overdue_display']
    ...
    fieldsets = (
        ('Fatura', {
            'fields': ('student', 'reference_month', 'due_date', 'status')
        }),
        ('Valores', {
            'fields': ('amount', 'discount', 'late_fee', 'total_amount')
        }),
        ('Descrição', {
...
class PaymentAdmin(ModelAdmin):
    list_display = ['invoice', 'payment_method', 'get_amount_display', 'payment_date', 'get_status_display']
    list_filter = ['status', 'payment_method', 'payment_date']
    search_fields = ['invoice__student__user__first_name', 'invoice__student__user__last_name', 'external_id']
