    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "medications",
                    models.TextField(blank=True, help_text="Medicamentos em uso"),
                ),
                (
                    "belt_color",
                    models.CharField(
                ...
                (
                    "notes",
                    models.TextField(blank=True, help_text="Observações do instrutor"),
                ),
                (
                    "user",
        ...
        migrations.AddIndex(
            model_name="student",
            index=models.Index(
                fields=["registration_number"], name="students_registr_f0f54d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="student",
            index=models.Index(
                fields=["belt_color"], name="students_belt_co_b58c72_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="student",
        ...
        migrations.AddIndex(
            model_name="student",
            index=models.Index(
                fields=["enrollment_date"], name="students_enrollm_89e94c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="graduation",
            index=models.Index(
                fields=["student", "graduation_date"],
                name="graduations_student_31c288_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="graduation",
            index=models.Index(
                fields=["graduation_date"], name="graduations_graduat_b5da5d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="attendance",
            index=models.Index(
                fields=["student", "class_date"], name="attendances_student_bde940_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="attendance",
            index=models.Index(
                fields=["class_date"], name="attendances_class_d_77ff13_idx"
            ),
        ),
